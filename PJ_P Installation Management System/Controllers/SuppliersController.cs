...
namespace PJ_P_Installation_Management_System.Controllers
{
    public class SuppliersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("SupplierId,CompanyName,ContactPerson,Phone,Email,IsActive")] Supplier supplier)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SupplierId,CompanyName,ContactPerson,Phone,Email,IsActive")] Supplier supplier)
        {
