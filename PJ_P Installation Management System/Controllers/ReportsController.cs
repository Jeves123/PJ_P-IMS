...
namespace PJ_P_Installation_Management_System.Controllers
{
    public class ReportsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ReportId,ReportType,GeneratedOn,FilePath")] Report report)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ReportId,ReportType,GeneratedOn,FilePath")] Report report)
        {
