...
namespace PJ_P_Installation_Management_System.Controllers
{
    public class StaffsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("StaffId,FullName,Position,ContactNumber,Email")] Staff staff)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StaffId,FullName,Position,ContactNumber,Email")] Staff staff)
        {
            if (id != staff.StaffId)
            {
                return NotFound();
